 ...
 */
public class TabLayoutUtil extends HorizontalScrollView {
    ...
    private static class StaticHandler extends Handler {
        ...
        private final WeakReference<TabLayoutUtil> mParent;

        public StaticHandler(Context context, TabLayoutUtil view) {
        ...
        public void handleMessage(Message msg) {
            ...
            TabLayoutUtil parent = mParent.get();
    ...
    public TabLayoutUtil(Context context) {
        this(context, null);
    }

    public TabLayoutUtil(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabLayoutUtil> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(TabLayoutUtil tabLayout) {
...
//            }
        ...
        public void onPageSelected(final int position) {
            final TabLayoutUtil tabLayout = mTabLayoutRef.get();
